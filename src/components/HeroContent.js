const HeroContent = () => {
  return (
    <section className="hero max-w-full py-14 lg:px-8 px-4 hero-bg">
      <div className="flex lg:flex-row flex-col border justify-center items-center">
        <div className="flex flex-col gap-16 border">
          <div className="flex flex-col justify-start lg:gap-10 gap-4">
            ...
            <div className="flex flex-col border lg:hidden max-sm:block">
              <img
        ...
        <div className="flex flex-col border lg:block max-sm:hidden">
          <img
            src="/images/Happy-Man.png"
            alt="Happy man representing satisfaction with the service"
            className="max-w-full h-auto object-contain w-[856px]"
